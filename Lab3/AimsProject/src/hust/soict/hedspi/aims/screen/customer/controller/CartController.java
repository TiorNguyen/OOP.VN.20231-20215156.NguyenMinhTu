...
//        }
        ...
        void btnPlayPressed(ActionEvent event) {
                ...
                if (media instanceof Playable) {
                        // Hiển thị dialog
                        try {
                                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../view/PlayDialog.fxml"));
                                Dialog<?> dialog = fxmlLoader.load();

                                // Lấy controller của dialog
                                PlayDialogController playDialogController = fxmlLoader.getController();
                                playDialogController.setPlayingTitle(media.getTitle());
